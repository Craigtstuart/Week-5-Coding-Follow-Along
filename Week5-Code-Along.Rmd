---
title: "Week5-Penguin Size Comparisons"
author: "Craig Stuart"
date: "11/9/2020"
...
```{r}
chinstrap_ttest <- t.test(chinstraps_m, chinstraps_f)
chinstrap_ttest

cohen.d(chinstraps_m, chinstraps_f)
```
Are male chinstrap penguins significantly larger (body mass) than female chinstrap penguins? # this is a one sided t-test
...
```{r}
penguins_counts <- penguins %>% #count function combines like observations within designated variables
  count(species, sex)
